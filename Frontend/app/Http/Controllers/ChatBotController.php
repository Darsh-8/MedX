    ...
    public function handle(Request $request)
    {
        try {
            ...
            if (in_array($query, ['hi', 'hello'])) {
                ...
                $reply = 'Sure, I can help you with uploading images or answering your queries.';
            } elseif ($query === 'upload') {
                $reply = 'You can upload your medical images by clicking the upload button in the interface.';
            } else {
